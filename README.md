...
- BCF2 parity through the same VCF logical compatibility path (Milestone 8 resource/inspection/schema foundation implemented; scientific parity pending);
