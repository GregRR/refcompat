...
- BCF2 parity through the same VCF logical compatibility path (Milestone 8 scoped/profile/reporting parity and internal adversarial review implemented; external milestone review pending);
...
- [`docs/vcf-contract-projection.md`](docs/vcf-contract-projection.md) — projection of VCF usage/REF facts into format-neutral requirements and evidence;
- [`docs/vcf-bundle-orchestration.md`](docs/vcf-bundle-orchestration.md) — anchor-owned pair-derived VCF REF evidence in whole-bundle reasoning;
- [`docs/vcf-ref-conflict-patterns.md`](docs/vcf-ref-conflict-patterns.md) — threshold-free interpretation of VCF REF conflict distribution;
- [`docs/alignment-header-observation.md`](docs/alignment-header-observation.md) — BAM/CRAM SAM-header observation boundary;
- [`docs/alignment-contract-projection.md`](docs/alignment-contract-projection.md) — BAM/CRAM `@SQ` presence, length, and declared-M5 requirement projection;
- [`docs/alignment-sequence-binding.md`](docs/alignment-sequence-binding.md) — conservative BAM/CRAM cross-name binding from uniquely verified `@SQ M5` identity;
