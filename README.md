...
Milestone 9 Slices 1–2 now pin the BED coordinate-compatibility contract and
implement its atomic layout/resource/schema foundation. BED inspection and
coordinate reasoning remain pending. Liftover, broad workflow validation,
