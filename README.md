...
- BCF2 parity through the same VCF logical compatibility path (Milestone 8 core RCHECK-050 parity implemented; scoped/profile/reporting parity pending);
