...
Milestone 9 now pins the BED coordinate-compatibility contract; BED implementation remains pending. Liftover, broad workflow validation, automatic repair, and complex ecosystem profiles are intentionally deferred.
...
Milestone 9 is contract-pinned and implementation is pending. It will add
standard BED coordinate compatibility through explicit layout declarations,
native zero-based half-open observations, generic sparse presence/bounds
reasoning, and an exact `3.0.0` report-schema transition.
