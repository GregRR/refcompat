...
**Status:** implemented as the fourth Milestone 2 reasoning slice. Top-level
compatibility verdict aggregation, conflict-core extraction, analysis status,
and stable `CompatibilityReport` serialization remain later work.
...
- mandatory/advisory bundle policy;
