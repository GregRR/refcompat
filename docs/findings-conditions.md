...
**Status:** implemented as the third Milestone 2 reasoning slice. The following anchor-driven bundle, categorical verdict, and conflict-core slices are also implemented; stable `CompatibilityReport` serialization is now the pinned Milestone 7 boundary.
