...
- VCF and BAM/CRAM header observation use `pysam>=0.24,<0.25` behind narrow adapter boundaries. The 0.24 line supports Python >=3.8, provides CPython 3.10–3.14 wheels for RefCompat's tested range, and uses permissive MIT licensing.
