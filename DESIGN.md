...
- VCF/bgzipped VCF;
- BCF2 (Milestone 8; contract pinned, implementation pending);
...
(`1.0.0` core, additive current `1.1.0`). Remaining decisions are deliberately
