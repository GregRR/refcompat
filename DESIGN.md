...
12. implement the Milestone 7 immutable report, stable versioned machine schema, report-owned provenance/relationship context, human/workflow views, representative end-to-end coverage, and adversarial internal exit review (implementation/internal review complete; external milestone-boundary review pending);
